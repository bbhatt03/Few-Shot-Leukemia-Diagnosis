...
Original file is located at
    https://colab.research.google.com/drive/1rlv242szWzHZJth0-gM8Xw9KIMQ3v8G0
"""
...
zip_ref = zipfile.ZipFile('/content/C-NMC_training_data.zip', 'r') #Opens the zip file in read mode
...
n_inputs = model.classifier[0].in_features #refer to the fully connected layer only
...
def train(n_epochs, loaders, model, optimizer, criterion, use_cuda, save_path):
    ...
    for epoch in range(1, n_epochs+1):
        ...
        for batch_idx, (data,target) in enumerate(trainloader):
            ...
            # Append to train_loss_count list
        ...
        for batch_idx, (data,target) in enumerate(validloader):
            ...
            # Append to  val_loss_count list
            val_loss_count.append(train_loss)
...
# Train the model
model_transfer = train(50, loaders, model, optimizer_transfer, criterion_transfer, use_cuda, 'model_transfer.pt')
...
# call test function
test(loaders, model, criterion_transfer, use_cuda)
